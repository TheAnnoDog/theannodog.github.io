...
/* profiles/contrib/droopler/themes/custom/droopler_theme/templates/media-library/fieldset--media-library-widget.html.twig */
class __TwigTemplate_498489133bb598abf3392ba48b9348e3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["prefix"] ?? null), "weight_toggle", [], "any", false, false, true, 53)) {
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 60)) {
            // line 61
            echo "      <small";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 61), "addClass", [0 => "description"], "method", false, false, true, 61), "addClass", [0 => "text-muted"], "method", false, false, true, 61), "addClass", [0 => "d-block"], "method", false, false, true, 61), 61, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return "profiles/contrib/droopler/themes/custom/droopler_theme/templates/media-library/fieldset--media-library-widget.html.twig";
    }
    ...
    {
        return new Source("", "profiles/contrib/droopler/themes/custom/droopler_theme/templates/media-library/fieldset--media-library-widget.html.twig", "/var/www/html/site/web/profiles/contrib/droopler/themes/custom/droopler_theme/templates/media-library/fieldset--media-library-widget.html.twig");
    }
